...
app.state.config.UI_LOGIN_LOGO_URL = UI_LOGIN_LOGO_URL
app.state.config.UI_LOGIN_TITLE = UI_LOGIN_TITLE
app.state.config.UI_LOGIN_SUBTITLE = UI_LOGIN_SUBTITLE
app.state.config.UI_CHAT_BACKGROUND_IMAGE_URL = UI_CHAT_BACKGROUND_IMAGE_URL
