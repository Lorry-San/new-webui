					...
					>
						...
						<a
							...
							class="min-w-fit p-1.5 {$page.url.pathname.includes('/admin/subscriptions')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition select-none"
							href="/admin/subscriptions">{$i18n.t('Subscriptions')}</a
						>

						<a
							draggable="false"
							class="min-w-fit p-1.5 {$page.url.pathname.includes('/admin/payment-providers')
								? ''
								: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition select-none"
							href="/admin/payment-providers">{$i18n.t('Payments')}</a
						>
